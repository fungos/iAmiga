...
- (void)startIntroSequence {
    ...
    NSMutableArray *sequence = [NSMutableArray arrayWithObjects:
                                [FadeAction actionWithFadeIn:1.0f holdTime:13.0f fadeOut:1.0f forImageNamed:@"intro_1"],
                                [FadeAction actionWithFadeIn:1.0f holdTime:3.5f fadeOut:1.0f forImageNamed:@"intro_2"],
                                [FadeAction actionWithFadeIn:1.0f holdTime:10.0f fadeOut:1.0f forImageNamed:@"intro_3"],
